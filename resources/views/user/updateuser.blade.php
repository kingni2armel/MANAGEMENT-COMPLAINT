                    ...
                    <div class="main-panel">
                      ...
                      @endif
                                    ...
                                    @foreach ($user as $data )
                                                <form class="forms-sample" action="{{route('UPDATEUSER',['id'=>$_GET['id']]) }}" method="POST">
                                                    @csrf

                                                <div class="form-group">
                                                    <label for="exampleInputCity1">Nom complet de l'utilisateur </label>
                                                    <input type="text" class="form-control" name="nomuser" id="exampleInputCity1" value="{{$data->name}}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputCity1">Email de l'utilisateur </label>
                                                    <input type="email" class="form-control" name="emailuser" id="exampleInputCity1" value="{{$data->email}}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputCity1">Téléphone  de l'utilisateur </label>
                                                    <input type="number" class="form-control" name="phoneuser" id="exampleInputCity1" value="{{$data->telephone}}">
                                                </div>
