...
<body>
                    ...
                    <div class="main-panel">
                      ...
                      @endif
                                    ...
                                    <form class="forms-sample" action="{{route('ADDSOUSCATEGORY') }}" method="POST">
                                        @csrf
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nomsouscategorie" id="exampleInputCity1" placeholder="Entrer le nom de la catégorie">
                                      </div>
                                      <div class="form-group">
                                        <label for="exampleTextarea1">Commentaire de la sous catégorie</label>
                                        <textarea class="form-control" name="commentairesouscategorie" style="height: 100px !important" id="exampleTextarea1" rows=""></textarea>
                                      </div>
